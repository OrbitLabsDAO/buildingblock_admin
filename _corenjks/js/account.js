    ...
    if (checkElement("#inp-email") == true) {
      ...
      document
        ...
        .addEventListener("keyup", function () {
          ...
          else document.getElementById("inp-username").value = tmp2[0];
      ...
      document
        ...
        .addEventListener("click", function () {
          ...
          if (checkPassword(password1.value) == false) {
            ...
            let error = document.getElementById("error-password1");
            error.innerHTML =
              "The password must be at least 8 letter characters, with a symbol, a upper and lower case letter and a number";
            error.classList.remove("d-none");
          }
